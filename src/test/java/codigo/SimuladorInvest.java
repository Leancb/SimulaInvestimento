...
import service.ApiServiceInvestimento;
...
public class SimuladorInvest {
    ...
    @Quando("^que irei validar UI da simulação de investimento$")
    public void configura() {

    }

    @Quando("^Testar o retorno da API")
    ...
    @Dado("^Api esta funcionando$")
    public void configuraOK() {
